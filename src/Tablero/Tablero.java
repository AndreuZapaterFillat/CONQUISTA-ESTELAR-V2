vacuna, enfActDerr, brotDerr, usuario, contra, porcVac); // Mostrar la ventana con la información
            }
        });
        ...
        planetas[8].addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	mostrarVentana(ciudades[8], ciudades, infectadasRonda,  planetas[8], vacuna, enfActDerr, brotDerr, usuario, contra, porcVac); // Mostrar la ventana con la información
            }
        });
        ...
        planetas[7].addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	mostrarVentana(ciudades[7], ciudades, infectadasRonda,  planetas[7], vacuna, enfActDerr, brotDerr, usuario, contra, porcVac); // Mostrar la ventana con la información
            }
        });
        ...
        planetas[6].addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	mostrarVentana(ciudades[6], ciudades, infectadasRonda,  planetas[6], vacuna, enfActDerr, brotDerr, usuario, contra, porcVac); // Mostrar la ventana con la información
            }
        });
        ...
        planetas[5].addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	mostrarVentana(ciudades[5], ciudades, infectadasRonda,  planetas[5], vacuna, enfActDerr, brotDerr, usuario, contra, porcVac); // Mostrar la ventana con la información
            }
        });
        ...
        planetas[4].addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	mostrarVentana(ciudades[4], ciudades, infectadasRonda,  planetas[4], vacuna, enfActDerr, brotDerr, usuario, contra, porcVac); // Mostrar la ventana con la información
            }
        });
        ...
        planetas[3].addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	mostrarVentana(ciudades[3], ciudades, infectadasRonda,  planetas[3], vacuna, enfActDerr, brotDerr, usuario, contra, porcVac); // Mostrar la ventana con la información
            }
        });
        ...
        planetas[2].addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	mostrarVentana(ciudades[2], ciudades, infectadasRonda,  planetas[2], vacuna, enfActDerr, brotDerr, usuario, contra, porcVac); // Mostrar la ventana con la información
            }
        });
        ...
        planetas[1].addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	mostrarVentana(ciudades[1], ciudades, infectadasRonda,  planetas[1], vacuna, enfActDerr, brotDerr, usuario, contra, porcVac); // Mostrar la ventana con la información
            }
        });
        ...
        planetas[0].addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	mostrarVentana(ciudades[0], ciudades, infectadasRonda,  planetas[0], vacuna, enfActDerr, brotDerr, usuario, contra, porcVac); // Mostrar la ventana con la información
            }
        });
	...
	private void mostrarVentana(Ciudad ciudad, Ciudad [] ciudades, int infectadasRonda, JButton boton, Vacunas [] vacuna, int enfActDerr, int brotDerr, String usuario, String contra, int porcVac) {
            ...
            public void actionPerformed(ActionEvent e) {
            	...
            	if(ciudad.getinfeccion() != 0 && acciones != 0) { 		
            		...
            		if(acciones == 0) {
                		...
                		modifcarAcciones();
                		pasarRonda();
                		infectarCiudades(ciudades, ciudad, infectadasRonda, enfActDerr, brotDerr, usuario, contra, porcVac);
            		}
	...
	private void infectarCiudades(Ciudad [] ciudades, Ciudad ciudad, int infectadasRonda, int enfActDerr, int brotDerr, String usuario, String contra, int porcVac) {
		int i = 0;
		int j = 0;
		...
		while(j != infectadasRonda && enfAct != enfActDerr) {
			if((int)(Math.random()*20) == 2) {
				...
				if(ciudades[i].getinfeccion() >= 0 && ciudades[i].getinfeccion() < 3 ) {
					...
					brotarCiudades(ciudades, ciudades[i], infectadasRonda, enfActDerr, brotDerr, usuario, contra, porcVac);
				}
			}
		...
		if(enfAct >= enfActDerr && perder < 1) {
			...
			double puntuacionFinal = calcularPuntuacion(infectadasInicio, infectadasRonda, enfActDerr, brotDerr, porcVac, ronda, usuario);
	...
	private void brotarCiudades(Ciudad[] ciudades, Ciudad ciudad, int infectadasRonda, int enfActDerr, int brotDerr, String usuario, String contra, int porcVac) {
		numBrot++;
	...
	public static double calcularPuntuacion(int ciudadesInfectadasInicio, int ciudadesInfectadasRonda, int enfermedadesActivasPerder, int brotesActivosPerder, int porcentajeDesarrolloVacuna, int rondas, String usuario) {
			...
			Connection con = bbdd.conectarBaseDatos();
			bbdd.insert(con, "INSERT INTO PANDEMIC_RANKING (USUARIO, PUNTUACION)"
					+ "VALUES ('"+usuario+"',"+puntuacionFinal+")");
